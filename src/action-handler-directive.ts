...
// TODO You need to replace all instances of "action-handler-sojjotemperature" with "action-handler-<your card name>"
customElements.define('action-handler-sojjotemperature', ActionHandler);

const getActionHandler = (): ActionHandler => {
  const body = document.body;
  if (body.querySelector('action-handler-sojjotemperature')) {
    return body.querySelector('action-handler-sojjotemperature') as ActionHandler;
  }

  const actionhandler = document.createElement('action-handler-sojjotemperature');
